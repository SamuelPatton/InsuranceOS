...
insert into policies (
  ...
  -- ── Martinez ───────────────────────────────────────────────
  -- Rosa: Medicare Advantage (original)
  ('c1000000-0000-0000-0000-000000000001',
   ...
   '2025-01-01', null, '2026-01-01', 0.00, 600.00),

  -- Rosa: Part D (original)
  ('c1000000-0000-0000-0000-000000000002',
   'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001',
   'SilverScript', 'Choice Plus', 'pdp', 'active',
   '2025-01-01', null, '2026-01-01', 24.70, 100.00),

  -- Carlos: Medicare Supplement Plan G (original)
  ('c1000000-0000-0000-0000-000000000003',
   ...
   '2021-07-01', null, '2026-07-01', 145.00, 200.00),

  -- ── Johnson ────────────────────────────────────────────────
  -- Patricia: Term Life (original)
  ('c1000000-0000-0000-0000-000000000004',
   ...
   '2022-04-01', null, '2026-04-01', 67.00, 804.00),

  -- ── Thompson ───────────────────────────────────────────────
  -- Harold: Medicare Supplement Plan G
  ('c1000000-0000-0000-0000-000000000005',
   ...
   '2019-03-01', null, '2026-03-01', 195.00, 265.00),

  -- Harold: Part D
  ('c1000000-0000-0000-0000-000000000006',
   'a1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000004',
   'SilverScript', 'Enhanced Plus', 'pdp', 'active',
   '2025-01-01', null, '2026-01-01', 29.40, 100.00),

  -- Evelyn: Medicare Advantage
  ('c1000000-0000-0000-0000-000000000007',
   ...
   '2025-01-01', null, '2026-01-01', 0.00, 572.00),

  -- ── Williams ───────────────────────────────────────────────
  -- Dorothy: Medicare Supplement Plan N
  ('c1000000-0000-0000-0000-000000000008',
   ...
   '2020-02-01', null, '2026-02-01', 148.00, 215.00),

  -- Dorothy: Dental
  ('c1000000-0000-0000-0000-000000000009',
   'a1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000006',
   'Ameritas', 'Dental Preferred PPO', 'dental', 'active',
   '2020-02-01', null, '2026-02-01', 33.00, 78.00),

  -- ── Anderson ───────────────────────────────────────────────
  -- Robert: Medicare Advantage
  ('c1000000-0000-0000-0000-000000000010',
   ...
   '2024-01-01', null, '2026-01-01', 0.00, 557.00),

  -- Margaret: Medicare Advantage
  ('c1000000-0000-0000-0000-000000000011',
   ...
   '2025-01-01', null, '2026-01-01', 18.00, 587.00),

  -- Margaret: Part D
  ('c1000000-0000-0000-0000-000000000012',
   'a1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000008',
   'WellCare', 'Value Rx S5601-003', 'pdp', 'active',
   '2025-01-01', null, '2026-01-01', 22.50, 100.00),

  -- ── Davis (pre-Medicare couple) ────────────────────────────
  -- Gerald: Health
  ...
  ('c1000000-0000-0000-0000-000000000018',
   ...
   '2025-01-01', null, '2026-01-01', 0.00, 611.00),

  -- Elena: Health (dependent, pre-Medicare)
  ('c1000000-0000-0000-0000-000000000019',
   ...
   '2023-10-01', null, '2025-10-01', 392.00, 470.00),

  -- ── Rodriguez (null renewal — missing data) ────────────────
  -- Frank: Medicare Advantage — renewal_date intentionally null
  ('c1000000-0000-0000-0000-000000000020',
   ...
   '2024-01-01', null, null, 0.00, 557.00),

  -- ── Wilson (multi-policy couple) ───────────────────────────
  -- Charles: Medicare Supplement Plan G
  ...
  ('c1000000-0000-0000-0000-000000000026',
   ...
   '2012-06-01', null, '2026-06-01', 248.00, 310.00),

  -- Helen: Final Expense Whole Life
  ('c1000000-0000-0000-0000-000000000027',
   'a1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000017',
   'Transamerica', 'Final Expense Whole Life 15K', 'life', 'active',
   '2018-06-01', null, '2026-06-01', 87.00, 310.00),

  -- Helen: Dental
  ('c1000000-0000-0000-0000-000000000028',
   'a1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000017',
   'Ameritas', 'Preferred Plus Dental PPO', 'dental', 'active',
   '2018-06-01', null, '2026-06-01', 28.00, 58.00),

  -- ── Taylor (pre-Medicare couple) ───────────────────────────
  -- James: Term Life
  ...
  ('c1000000-0000-0000-0000-000000000037',
   ...
   '2023-01-01', '2024-01-01', '2024-01-01', 510.00, 765.00),

  -- Barbara: Medicare Advantage (active)
  ...
  ('c1000000-0000-0000-0000-000000000042',
   ...
   '2019-03-01', null, '2026-03-01', 112.00, 1344.00),

  -- ── Lewis (MAPD couple + ancillary) ────────────────────────
  -- George: Medicare Advantage
  ...
  -- Arthur: Medicare Advantage — pending
  ('c1000000-0000-0000-0000-000000000047',
   ...
   '2026-01-01', null, '2027-01-01', 0.00, 611.00),

  -- ── Walker ─────────────────────────────────────────────────
  -- Edward: Medicare Supplement Plan N
  ('c1000000-0000-0000-0000-000000000048',
   'a1000000-0000-0000-0000-000000000018', 'b1000000-0000-0000-0000-000000000030',
   'Cigna', 'Medicare Supplement Plan N', 'medicare_supplement', 'active',
   '2016-01-01', null, '2026-01-01', 162.00, 220.00),
  ...
  ('c1000000-0000-0000-0000-000000000051',
   ...
   '2024-01-01', null, '2026-01-01', 28.00, 60.00),

  -- ── Hall (null renewal — missing data) ─────────────────────
  -- Marjorie: Medicare Supplement Plan G — renewal_date intentionally null
  ('c1000000-0000-0000-0000-000000000052',
   'a1000000-0000-0000-0000-000000000019', 'b1000000-0000-0000-0000-000000000032',
   'UnitedHealthcare', 'AARP Medicare Supplement Plan G', 'medicare_supplement', 'active',
   '2020-03-01', null, null, 168.00, 230.00),

  -- ── Allen (MAPD couple with PDP) ───────────────────────────
  -- Raymond: Medicare Advantage
  ('c1000000-0000-0000-0000-000000000053',
   'a1000000-0000-0000-0000-000000000020', 'b1000000-0000-0000-0000-000000000033',
   'Humana', 'Gold Plus H5619-014', 'medicare_advantage', 'active',
   '2025-01-01', null, '2026-01-01', 0.00, 557.00),
